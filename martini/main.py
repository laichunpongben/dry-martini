...
from .models import Security, SecuritySchema, Base
...
async def get_security_by_isin(isin: str, db: AsyncSession = Depends(get_db)):
...
if __name__ == "__main__":
    # No reload here—use the CLI for that!
    uvicorn.run(
        "martini.main:app",
        host="::",
        port=6010,
